package de.pure.diva.arf.reasoner.designtime;
...
public class DesigntimeReasoner extends ReasonerService implements Reasoner {
  public static final String              NAME      = "Design-time Reasoner";

  private static final ReasonerAttributes PARAMETER = new ReasonerAttributes();

  private DummySolver                     solver    = new DummySolver();

  public DesigntimeReasoner() {
