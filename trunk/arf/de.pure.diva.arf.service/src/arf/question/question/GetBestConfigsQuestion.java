...
public class GetBestConfigsQuestion extends QuestionService implements Question {

  private QuestionAttributes parameters = new QuestionAttributes();

  public GetBestConfigsQuestion() {
  ...
  public String getName() {
    return ARF.QUESTIONS.GET_BEST_VALID_CONFIGURATIONS;
  }
  ...
  public String getQuestion() {
    return "Get best valid configuration.";
  }
}
