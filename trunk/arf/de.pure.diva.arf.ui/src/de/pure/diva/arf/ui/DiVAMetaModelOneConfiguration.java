...
public class DiVAMetaModelOneConfiguration extends DiVAMetaModelAction {

  @Override
  protected void run(IProgressMonitor monitor, Resource vmodel) throws Exception {
    QuestionHandle question = new arf.question.QuestionHandle(ARF.QUESTIONS.GET_ONE_VALID_CONFIGURATION);
    ReasonerHandle reasoner = getReasoner(vmodel, "One Configurations", question);
    if (reasoner != null) {
      ...
      ResultRunnable runnable = new ResultRunnable(results, "Get One Configuration", logging);
