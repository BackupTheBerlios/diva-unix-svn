...
public class InstanceFactoryImpl extends EFactoryImpl implements InstanceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case InstancePackage.PRIMITIVE_INSTANCE: return (EObject)createPrimitiveInstance();
			case InstancePackage.COMPOSITE_INSTANCE: return (EObject)createCompositeInstance();
			case InstancePackage.TRANSMISSION_BINDING: return (EObject)createTransmissionBinding();
			case InstancePackage.DELEGATION_BINDING: return (EObject)createDelegationBinding();
			case InstancePackage.VALUED_ATTRIBUTE: return (EObject)createValuedAttribute();
			case InstancePackage.DICTIONARY_VALUED_ATTRIBUTE: return (EObject)createDictionaryValuedAttribute();
			case InstancePackage.DEFAULT_ENTRY: return (EObject)createDefaultEntry();
			case InstancePackage.OTHER_ENTRY: return (EObject)createOtherEntry();
			default:
