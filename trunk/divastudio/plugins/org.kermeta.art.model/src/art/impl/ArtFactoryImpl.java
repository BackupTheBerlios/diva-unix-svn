...
public class ArtFactoryImpl extends EFactoryImpl implements ArtFactory {
	...
	public static ArtFactory init() {
		try {
			ArtFactory theArtFactory = (ArtFactory)EPackage.Registry.INSTANCE.getEFactory("http://art"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ArtPackage.SYSTEM: return (EObject)createSystem();
			case ArtPackage.DATA_TYPE: return (EObject)createDataType();
			default:
