 ...
 *   <li>{@link art.type.impl.AbstractPortImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link art.type.impl.AbstractPortImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractPortImpl extends NamedElementImpl implements AbstractPort {
	...
	public void setProtocol(String newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ABSTRACT_PORT__PROTOCOL, oldProtocol, protocol));
	}
	...
	public void setUri(String newUri) {
		...
		uri = newUri;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ABSTRACT_PORT__URI, oldUri, uri));
	}
