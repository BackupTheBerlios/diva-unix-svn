...
public class TypeFactoryImpl extends EFactoryImpl implements TypeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TypePackage.PRIMITIVE_TYPE: return (EObject)createPrimitiveType();
			case TypePackage.COMPOSITE_TYPE: return (EObject)createCompositeType();
			case TypePackage.OPERATION: return (EObject)createOperation();
			case TypePackage.PARAMETER: return (EObject)createParameter();
			case TypePackage.FUNCTIONAL_SERVICE: return (EObject)createFunctionalService();
			case TypePackage.CONTROL_SERVICE: return (EObject)createControlService();
			case TypePackage.PORT: return (EObject)createPort();
			case TypePackage.PORT_COLLECTION: return (EObject)createPortCollection();
			case TypePackage.PORT_ID: return (EObject)createPortId();
			case TypePackage.BASIC_ATTRIBUTE: return (EObject)createBasicAttribute();
			case TypePackage.DICTIONARY: return (EObject)createDictionary();
			case TypePackage.DICTIONARY_DEFAULT_VALUE: return (EObject)createDictionaryDefaultValue();
			default:
