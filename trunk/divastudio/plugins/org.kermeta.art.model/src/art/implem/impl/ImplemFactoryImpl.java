...
public class ImplemFactoryImpl extends EFactoryImpl implements ImplemFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ImplemPackage.FRACTAL_COMPONENT: return (EObject)createFractalComponent();
			case ImplemPackage.OS_GI_COMPONENT: return (EObject)createOSGiComponent();
			case ImplemPackage.OS_GI_TYPE: return (EObject)createOSGiType();
			default:
