...
public class NextAlloySolutionListener extends AlloySolutionListener {
  ...
  public NextAlloySolutionListener(Resource mResource, Resource cResource, AlloyConnector connector, Mapper mapper, ARFModel model, ARFContext context) {
