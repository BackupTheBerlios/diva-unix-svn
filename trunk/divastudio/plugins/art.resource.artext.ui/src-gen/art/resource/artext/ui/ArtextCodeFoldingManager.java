 ...
 */
public class ArtextCodeFoldingManager {
	
	private class FoldingUpdateListener implements art.resource.artext.IArtextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(art.resource.artext.ui.ArtextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof art.resource.artext.ui.ArtextEditor) {
				art.resource.artext.ui.ArtextEditor editor = (art.resource.artext.ui.ArtextEditor) workbenchPart;
	...
	protected art.resource.artext.ui.ArtextEditor editor;
	 ...
	 */
	public ArtextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,art.resource.artext.ui.ArtextEditor textEditor) {
	...
	private void addCloseListener(final art.resource.artext.ui.ArtextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			art.resource.artext.ui.ArtextUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		art.resource.artext.IArtextTextResource textResource = (art.resource.artext.IArtextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
