 ...
 */
public class ArtextNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public ArtextNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new artext file");
