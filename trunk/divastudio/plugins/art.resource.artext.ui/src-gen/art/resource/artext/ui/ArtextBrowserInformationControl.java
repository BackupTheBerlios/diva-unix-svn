 ...
 * @since 3.2
 */
public class ArtextBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private art.resource.artext.ui.ArtextDocBrowserInformationControlInput fInput;
	 ...
	 */
	public ArtextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public ArtextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public ArtextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof art.resource.artext.ui.ArtextDocBrowserInformationControlInput);
		...
		fInput= (art.resource.artext.ui.ArtextDocBrowserInformationControlInput) input;
		...
		art.resource.artext.ui.ArtextHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = art.resource.artext.ui.ArtextHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public art.resource.artext.ui.ArtextDocBrowserInformationControlInput getInput() {
		return fInput;
	}
