 ...
 */
public class ArtextTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private art.resource.artext.IArtextHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final art.resource.artext.ui.ArtextBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(art.resource.artext.ui.ArtextBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			art.resource.artext.ui.ArtextDocBrowserInformationControlInput infoInput = (art.resource.artext.ui.ArtextDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					art.resource.artext.ui.ArtextHyperlink hyperlink = new art.resource.artext.ui.ArtextHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (art.resource.artext.ui.ArtextBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				art.resource.artext.ui.ArtextBrowserInformationControl iControl = new art.resource.artext.ui.ArtextBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof art.resource.artext.ui.ArtextDocBrowserInformationControlInput) {
							art.resource.artext.ui.ArtextDocBrowserInformationControlInput input = (art.resource.artext.ui.ArtextDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (art.resource.artext.ui.ArtextBrowserInformationControl.isAvailable(parent)) {
				art.resource.artext.ui.ArtextBrowserInformationControl iControl = new art.resource.artext.ui.ArtextBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public ArtextTextHover(art.resource.artext.ui.ArtextEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new art.resource.artext.ui.ArtextUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((art.resource.artext.ui.ArtextDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private art.resource.artext.ui.ArtextDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		art.resource.artext.IArtextTextResource textResource = editor.getResource();
	 ...
	 */
	private art.resource.artext.ui.ArtextDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, art.resource.artext.ui.ArtextDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				art.resource.artext.ui.ArtextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			art.resource.artext.ui.ArtextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			art.resource.artext.ui.ArtextHTMLPrinter.insertPageProlog(buffer, 0, art.resource.artext.ui.ArtextTextHover.getStyleSheet());
			art.resource.artext.ui.ArtextHTMLPrinter.addPageEpilog(buffer);
			return new art.resource.artext.ui.ArtextDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = art.resource.artext.ui.ArtextHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(art.resource.artext.ui.ArtextUIPlugin.PLUGIN_ID);
