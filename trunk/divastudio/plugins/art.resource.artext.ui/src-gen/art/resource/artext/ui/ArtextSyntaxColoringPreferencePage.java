 ...
 */
public class ArtextSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = art.resource.artext.ui.ArtextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, art.resource.artext.ui.ArtextSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		art.resource.artext.ui.ArtextPixelConverter pixelConverter = new art.resource.artext.ui.ArtextPixelConverter(composite);
	...
	public ArtextSyntaxColoringPreferencePage() {
		super();
		
		art.resource.artext.IArtextMetaInformation syntaxPlugin = new art.resource.artext.mopp.ArtextMetaInformation();
		...
		setPreferenceStore(art.resource.artext.ui.ArtextUIPlugin.getDefault().getPreferenceStore());
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof art.resource.artext.ui.ArtextEditor) {
			art.resource.artext.ui.ArtextEditor emfTextEditor = (art.resource.artext.ui.ArtextEditor) editor;
