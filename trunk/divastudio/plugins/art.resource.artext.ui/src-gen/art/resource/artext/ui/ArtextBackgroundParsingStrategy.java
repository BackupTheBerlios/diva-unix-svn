 ...
 */
public class ArtextBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final art.resource.artext.IArtextTextResource resource, final art.resource.artext.ui.ArtextEditor editor) {
		if (resource == null) {
			return;
		}
