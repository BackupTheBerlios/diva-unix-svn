 ...
 */
public class ArtextImageProvider {
	
	public final static ArtextImageProvider INSTANCE = new ArtextImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(art.resource.artext.ui.ArtextUIPlugin.getDefault().getBundle(), path, null));
