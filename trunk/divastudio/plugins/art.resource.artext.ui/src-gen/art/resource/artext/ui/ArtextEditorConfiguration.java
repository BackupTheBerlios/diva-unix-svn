...
public class ArtextEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private art.resource.artext.ui.ArtextQuickAssistAssistant quickAssistAssistant;
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner(String fileName) {
		return new art.resource.artext.ui.ArtextTokenScanner(theEditor.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new art.resource.artext.ui.ArtextQuickAssistAssistant(theEditor);
		}
