 ...
 */
public class ArtextPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(art.resource.artext.ui.ArtextUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Artext Text Editor Preferences");
	}
