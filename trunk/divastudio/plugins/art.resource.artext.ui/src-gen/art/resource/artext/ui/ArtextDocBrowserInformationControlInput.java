 ...
 * olInput</code>.
 */
public class ArtextDocBrowserInformationControlInput {
	
	private final ArtextDocBrowserInformationControlInput fPrevious;
	private ArtextDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ArtextDocBrowserInformationControlInput(ArtextDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ArtextDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ArtextDocBrowserInformationControlInput getNext() {
		return fNext;
	}
