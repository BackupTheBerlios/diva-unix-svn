 ...
 */
public class ArtextUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "art.resource.artext.ui";
	...
	private static ArtextUIPlugin plugin;
	
	public ArtextUIPlugin() {
		super();
	}
	...
	public static ArtextUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ArtextUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ArtextUIPlugin.PLUGIN_ID, message);
		}
		final ArtextUIPlugin pluginInstance = ArtextUIPlugin.getDefault();
