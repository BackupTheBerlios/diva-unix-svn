...
public class ComputeConfigVerdictsQuestion extends WP2SimulatorQuestion {

  private QuestionAttributes parameters = new QuestionAttributes();

  public ComputeConfigVerdictsQuestion() {
  ...
  public String getName() {
    return WP2SimulatorQuestion.QUESTIONS.COMPUTE_CONFIGURATION_VERDICTS;
  }

  public String getQuestion() {
    return "Compute configuration verdicts.";
  }
}
