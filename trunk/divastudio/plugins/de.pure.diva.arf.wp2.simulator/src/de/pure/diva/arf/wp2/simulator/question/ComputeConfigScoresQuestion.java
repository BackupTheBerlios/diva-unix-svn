...
public class ComputeConfigScoresQuestion extends WP2SimulatorQuestion {

  private QuestionAttributes parameters = new QuestionAttributes();

  public ComputeConfigScoresQuestion() {
  ...
  public String getName() {
    return WP2SimulatorQuestion.QUESTIONS.COMPUTE_CONFIGURATION_SCORES;
  }

  public String getQuestion() {
    return "Compute configuration scores.";
  }
}
