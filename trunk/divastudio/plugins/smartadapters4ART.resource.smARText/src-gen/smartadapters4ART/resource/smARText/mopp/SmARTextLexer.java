...
public class SmARTextLexer extends Lexer {
    ...
    public final void mANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15614:11: ( ( '@' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ ) )
            // SmARText.g:15615:2: ( '@' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )
            {
            // SmARText.g:15615:2: ( '@' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )
            // SmARText.g:15615:3: '@' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            {
            match('@'); 
            // SmARText.g:15615:6: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
    ...
    public final void mT_INSTANCE_STATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15618:17: ( ( '#ON' | '#OFF' ) )
            // SmARText.g:15619:2: ( '#ON' | '#OFF' )
            {
            // SmARText.g:15619:2: ( '#ON' | '#OFF' )
            int alt4=2;
    ...
    public final void mT_PORT_KIND() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15621:12: ( ( 'provided' | 'required' ) )
            // SmARText.g:15622:2: ( 'provided' | 'required' )
            {
            // SmARText.g:15622:2: ( 'provided' | 'required' )
            int alt5=2;
    ...
    public final void mT_IMPLEM() throws RecognitionException {
        try {
            int _type = T_IMPLEM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15624:9: ( ( 'bundle' | 'memory' ) )
            // SmARText.g:15625:2: ( 'bundle' | 'memory' )
            {
            // SmARText.g:15625:2: ( 'bundle' | 'memory' )
            int alt6=2;
    ...
    public final void mMULTIPLICITY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15627:13: ( ( ( ( '*' ) | ( ( '0' .. '9' )+ ) ) ) )
            // SmARText.g:15628:2: ( ( ( '*' ) | ( ( '0' .. '9' )+ ) ) )
            {
            // SmARText.g:15628:2: ( ( ( '*' ) | ( ( '0' .. '9' )+ ) ) )
            // SmARText.g:15628:3: ( ( '*' ) | ( ( '0' .. '9' )+ ) )
            {
            // SmARText.g:15628:3: ( ( '*' ) | ( ( '0' .. '9' )+ ) )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // SmARText.g:15628:13: ( ( '0' .. '9' )+ )
                    {
                    // SmARText.g:15628:13: ( ( '0' .. '9' )+ )
                    // SmARText.g:15628:14: ( '0' .. '9' )+
                    {
                    // SmARText.g:15628:14: ( '0' .. '9' )+
                    int cnt7=0;
                    loop7:
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15630:15: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ) | '\\\\' ( '0' .. '7' ) | ~ ( '\\\\' | '\"' ) )* '\"' ) )
            // SmARText.g:15631:2: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ) | '\\\\' ( '0' .. '7' ) | ~ ( '\\\\' | '\"' ) )* '\"' )
            {
            // SmARText.g:15631:2: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ) | '\\\\' ( '0' .. '7' ) | ~ ( '\\\\' | '\"' ) )* '\"' )
            // SmARText.g:15631:3: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ) | '\\\\' ( '0' .. '7' ) | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // SmARText.g:15631:6: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ) | '\\\\' ( '0' .. '7' ) | ~ ( '\\\\' | '\"' ) )*
            loop9:
            do {
                int alt9=5;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // SmARText.g:15631:48: ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            	    {
            	    // SmARText.g:15631:48: ( '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            	    // SmARText.g:15631:49: '\\\\' 'u' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            	    {
            	    match('\\'); 
            	    match('u'); 
            	    ...
            	    break;
            	case 3 :
            	    // SmARText.g:15631:170: '\\\\' ( '0' .. '7' )
            	    {
            	    match('\\'); 
            	    // SmARText.g:15631:174: ( '0' .. '7' )
            	    // SmARText.g:15631:175: '0' .. '7'
            	    {
            	    matchRange('0','7'); 
    ...
    public final void mWHITESPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15633:11: ( ( ( ' ' | '\\t' | '\\f' ) ) )
            // SmARText.g:15634:2: ( ( ' ' | '\\t' | '\\f' ) )
            {
            // SmARText.g:15634:2: ( ( ' ' | '\\t' | '\\f' ) )
            // SmARText.g:15634:3: ( ' ' | '\\t' | '\\f' )
            {
    ...
    public final void mTXTID() throws RecognitionException {
        try {
            int _type = TXTID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15641:6: ( ( '<' ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )* '>' ) )
            // SmARText.g:15642:2: ( '<' ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )* '>' )
            {
            // SmARText.g:15642:2: ( '<' ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )* '>' )
            // SmARText.g:15642:3: '<' ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )* '>'
            {
            match('<'); 
            ...
            // SmARText.g:15642:34: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )*
            loop11:
            do {
                int alt11=2;
            ...
            // SmARText.g:15642:81: ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // SmARText.g:15642:82: '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            	    {
            	    match('.'); 
            	    // SmARText.g:15642:85: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            	    int cnt12=0;
            	    loop12:
            	    do {
            	        int alt12=2;
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            int _type = TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SmARText.g:15644:5: ( ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '*' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+ )* ) )
            // SmARText.g:15645:2: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '*' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+ )* )
            {
            // SmARText.g:15645:2: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '*' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+ )* )
            // SmARText.g:15645:3: ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '*' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )* ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+ )*
            {
            ...
            // SmARText.g:15645:36: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )*
            loop14:
            do {
                int alt14=2;
            ...
            // SmARText.g:15645:88: ( '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+ )*
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // SmARText.g:15645:89: '.' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+
            	    {
            	    match('.'); 
            	    // SmARText.g:15645:92: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' | '*' )+
            	    int cnt15=0;
            	    loop15:
            	    do {
            	        int alt15=2;
    ...
    static final String DFA17_eotS =
        "\1\uffff\1\53\2\uffff\3\53\1\uffff\1\53\1\72\1\53\2\uffff\6\53"+
        "\1\uffff\1\53\6\uffff\2\53\1\uffff\1\53\1\115\1\uffff\1\53\3\uffff"+
    ...
    static final String DFA17_minS =
        "\1\11\1\145\2\uffff\1\144\1\145\1\154\1\uffff\1\145\1\72\1\154"+
        "\2\uffff\1\157\1\141\1\144\1\151\1\141\1\157\1\uffff\1\162\6\uffff"+
    ...
    static final String DFA17_acceptS =
        ...
        "\uffff\1\51\1\56\1\57\1\62\1\63\1\64\2\uffff\1\73\2\uffff\1\100"+
        "\2\uffff\1\110\1\111\2\uffff\1\114\1\115\1\116\1\117\1\121\14\uffff"+
        "\1\55\1\61\1\13\21\uffff\1\120\1\75\1\uffff\1\106\1\107\24\uffff"+
        "\1\54\4\uffff\1\43\22\uffff\1\11\4\uffff\1\15\24\uffff\1\50\6\uffff"+
        "\1\72\14\uffff\1\12\1\17\4\uffff\1\26\6\uffff\1\53\1\uffff\1\33"+
        "\1\44\17\uffff\1\27\3\uffff\1\30\3\uffff\1\23\25\uffff\1\4\3\uffff"+
    ...
    static final String[] DFA17_transitionS = {
            ...
            "\1\53\2\uffff\2\53\1\uffff\12\53\7\uffff\32\53\4\uffff\1\53"+
            "\1\uffff\32\53",
            "\1\53\2\uffff\2\53\1\uffff\12\53\7\uffff\17\53\1\u011f\12"+
            "\53\4\uffff\1\53\1\uffff\32\53",
            "\1\u0121",
            "\1\u0122",
            "\1\u0123",
            ...
            "\1\uffff\32\53",
            "",
            "\1\53\2\uffff\2\53\1\uffff\12\53\7\uffff\17\53\1\u0125\12"+
            "\53\4\uffff\1\53\1\uffff\32\53",
            "\1\53\2\uffff\2\53\1\uffff\12\53\7\uffff\32\53\4\uffff\1\53"+
            "\1\uffff\32\53",
            "\1\u0127",
