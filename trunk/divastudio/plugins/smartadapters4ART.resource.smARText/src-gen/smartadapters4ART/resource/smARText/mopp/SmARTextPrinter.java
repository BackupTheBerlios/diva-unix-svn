...
public class SmARTextPrinter implements smartadapters4ART.resource.smARText.ISmARTextTextPrinter {
	...
	public void print_smartadapters4ART_adaptations_SetruntimeNode_0(smartadapters4ART.adaptations.SetruntimeNode element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap){
		...
		while (iterate) {
			...
			out1 = new java.io.PrintWriter(sWriter);
			printCountingMap1 = new java.util.LinkedHashMap<String, Integer>(printCountingMap);
			print_smartadapters4ART_adaptations_SetruntimeNode_0_0(element, localtab, out1, printCountingMap1);
			if (printCountingMap.equals(printCountingMap1)) {
				iterate = false;
				out1.close();
			} else {
	...
	public void print_smartadapters4ART_adaptations_SetruntimeNode_0_0(smartadapters4ART.adaptations.SetruntimeNode element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap){
		int count;
		// DEFINITION PART BEGINS (CsString)
		out.print(",");
		// DEFINITION PART BEGINS (WhiteSpaces)
