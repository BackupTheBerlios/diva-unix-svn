...
public class ScoreImpl extends DiVAModelElementImpl implements Score {
	...
	protected EClass eStaticClass() {
		return DivaPackage.Literals.SCORE;
	}
	...
	public void setScore(int newScore) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.SCORE__SCORE, oldScore, score));
	}
	...
	public void setProperty(Property newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.SCORE__PROPERTY, oldProperty, property));
	}
