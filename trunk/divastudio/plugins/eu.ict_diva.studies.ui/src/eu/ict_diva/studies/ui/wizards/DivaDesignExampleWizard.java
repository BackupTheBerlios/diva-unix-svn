...
public class DivaDesignExampleWizard extends AbstractExampleWizard {
	...
	protected Collection getProjectDescriptors() {
		...
		projects.add(new ProjectDescriptor("eu.ict_diva.studies.ui", "zips/eu.ict_diva.studies.zip", "eu.ict_diva.studies"));
		return projects;
	}
