...
/**
 * This is the item provider adapter for a {@link diva.Score} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScoreItemProvider
	 ...
	 * @generated
	 */
	public ScoreItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DivaPackage.Literals.SCORE__SCORE,
				 true,
				 false,
				 false,
	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Score_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Score_property_feature", "_UI_Score_type"),
				 DivaPackage.Literals.SCORE__PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Score_type") + " " + score.getScore();
	}
