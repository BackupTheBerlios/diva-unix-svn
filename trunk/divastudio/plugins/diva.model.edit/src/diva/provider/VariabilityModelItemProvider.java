...
public class VariabilityModelItemProvider
	extends ModelContainerItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__CONTEXT);
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__PROPERTY);
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__DIMENSION);
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__RULE);
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__CONSTRAINT);
			childrenFeatures.add(DivaPackage.Literals.VARIABILITY_MODEL__SIMULATION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VariabilityModel"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_VariabilityModel_type");
	}
