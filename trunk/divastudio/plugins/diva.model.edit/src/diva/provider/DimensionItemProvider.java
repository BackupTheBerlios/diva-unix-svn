		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_property_feature", "_UI_Dimension_type"),
				 DivaPackage.Literals.DIMENSION__PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUpperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_upper_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_upper_feature", "_UI_Dimension_type"),
				 DivaPackage.Literals.DIMENSION__UPPER,
				 true,
				 false,
				 false,
	...
	protected void addLowerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_lower_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_lower_feature", "_UI_Dimension_type"),
				 DivaPackage.Literals.DIMENSION__LOWER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DivaPackage.Literals.DIMENSION__VARIANT,
				 DivaFactory.eINSTANCE.createVariant()));

		newChildDescriptors.add
			(createChildParameter
				(DivaPackage.Literals.DIMENSION__CONSTRAINTS,
