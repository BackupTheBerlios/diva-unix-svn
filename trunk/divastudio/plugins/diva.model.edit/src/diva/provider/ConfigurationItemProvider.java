...
/**
 * This is the item provider adapter for a {@link diva.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_verdict_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_verdict_feature", "_UI_Configuration_type"),
				 DivaPackage.Literals.CONFIGURATION__VERDICT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DivaPackage.Literals.CONFIGURATION__VARIANT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Configuration_type") + " " + configuration.getTotalScore();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DivaPackage.Literals.CONFIGURATION__VARIANT,
				 DivaFactory.eINSTANCE.createConfigVariant()));
	}
