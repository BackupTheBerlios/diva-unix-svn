...
public class ArtextResource extends org.eclipse.emf.ecore.resource.impl.ResourceImpl implements art.resource.artext.IArtextTextResource {
	...
	private java.util.Map<String, art.resource.artext.IArtextContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject>> internalURIFragmentMap = new java.util.LinkedHashMap<String, art.resource.artext.IArtextContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject>>();
	private java.util.Map<String, art.resource.artext.IArtextQuickFix> quickFixMap = new java.util.LinkedHashMap<String, art.resource.artext.IArtextQuickFix>();
	...
	public void addURIFragment(String internalURIFragment, art.resource.artext.IArtextContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject> uriFragment) {
	...
	public <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(art.resource.artext.IArtextContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, ContainerType container, org.eclipse.emf.ecore.EReference reference, String id, org.eclipse.emf.ecore.EObject proxyElement) {
		...
		String internalURIFragment = art.resource.artext.IArtextContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX + (proxyCounter++) + "_" + id;
	...
	private org.eclipse.emf.ecore.EObject getResultElement(art.resource.artext.IArtextContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject> uriFragment, art.resource.artext.IArtextReferenceMapping<? extends org.eclipse.emf.ecore.EObject> mapping, org.eclipse.emf.ecore.EObject proxy, final String errorMessage) {
	...
	private void removeDiagnostics(org.eclipse.emf.ecore.EObject cause, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics) {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic errorCand : new org.eclipse.emf.common.util.BasicEList<org.eclipse.emf.ecore.resource.Resource.Diagnostic>(diagnostics)) {
			if (errorCand instanceof art.resource.artext.IArtextTextDiagnostic) {
				if (((art.resource.artext.IArtextTextDiagnostic) errorCand).wasCausedBy(cause)) {
	...
	protected void runPostProcessors(java.util.Map<?, ?> loadOptions) {
		...
		Object resourcePostProcessorProvider = loadOptions.get(art.resource.artext.IArtextOptions.RESOURCE_POSTPROCESSOR_PROVIDER);
	...
	public void addProblem(art.resource.artext.IArtextProblem problem, org.eclipse.emf.ecore.EObject element) {
		...
		if (isMarkerCreationEnabled()) {
			art.resource.artext.mopp.ArtextMarkerHelper.mark(this, diagnostic);
		}
		java.util.Collection<art.resource.artext.IArtextQuickFix> quickFixes = problem.getQuickFixes();
		if (quickFixes != null) {
			for (art.resource.artext.IArtextQuickFix quickFix : quickFixes) {
				if (quickFix != null) {
	...
	protected java.util.Map<Object, Object> addDefaultLoadOptions(java.util.Map<?, ?> loadOptions) {
		java.util.Map<Object, Object> loadOptionsCopy = art.resource.artext.util.ArtextMapUtil.copySafelyToObjectToObjectMap(loadOptions);
	...
	private void addLoadOption(java.util.Map<Object, Object> options,Object key, Object value) {
		...
		if (options.containsKey(key)) {
			...
			if (currentValue instanceof java.util.List<?>) {
				...
				java.util.List<Object> currentValueAsObjectList = art.resource.artext.util.ArtextListUtil.copySafelyToObjectList(currentValueAsList);
	...
	protected void clearState() {
		...
		getWarnings().clear();
		if (isMarkerCreationEnabled()) {
			art.resource.artext.mopp.ArtextMarkerHelper.unmark(this);
		}
		proxyCounter = 0;
		resolverSwitch = null;
	}
	...
	public art.resource.artext.IArtextQuickFix getQuickFix(String quickFixContext) {
	...
	public boolean isMarkerCreationEnabled() {
		...
		return !loadOptions.containsKey(art.resource.artext.IArtextOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS);
	}
}
