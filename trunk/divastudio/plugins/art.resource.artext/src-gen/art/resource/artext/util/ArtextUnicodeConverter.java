 ...
 * to 4 bytes).
 */
public class ArtextUnicodeConverter extends art.resource.artext.mopp.ArtextInputStreamProcessor {
	 ...
	 */
	public ArtextUnicodeConverter(java.io.InputStream inputStream) {
