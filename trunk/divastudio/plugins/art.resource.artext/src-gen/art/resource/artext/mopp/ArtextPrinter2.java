...
public class ArtextPrinter2 implements art.resource.artext.IArtextTextPrinter {
	 ...
	 */
	public boolean decorateTreeBasic(art.resource.artext.mopp.ArtextSyntaxElementDecorator decorator, org.eclipse.emf.ecore.EObject eObject, java.util.Map<String, Integer> printCountingMap, java.util.List<art.resource.artext.mopp.ArtextSyntaxElementDecorator> keywordsToPrint) {
	 ...
	 */
	public boolean doesPrintFeature(art.resource.artext.mopp.ArtextSyntaxElementDecorator decorator, org.eclipse.emf.ecore.EObject eObject, java.util.Map<String, Integer> printCountingMap) {
		art.resource.artext.grammar.ArtextSyntaxElement syntaxElement = decorator.getDecoratedElement();
		...
		while (true) {
			...
			if (indexToPrint != null) {
				if (printElement instanceof art.resource.artext.grammar.ArtextKeyword) {
					...
					foundSomethingToPrint = true;
				} else if (printElement instanceof art.resource.artext.grammar.ArtextBooleanTerminal) {
					art.resource.artext.grammar.ArtextBooleanTerminal booleanTerminal = (art.resource.artext.grammar.ArtextBooleanTerminal) printElement;
	...
	public void printBooleanTerminal(org.eclipse.emf.ecore.EObject eObject, art.resource.artext.grammar.ArtextBooleanTerminal booleanTerminal, int count, java.util.List<art.resource.artext.grammar.ArtextFormattingElement> foundFormattingElements, java.util.List<art.resource.artext.mopp.ArtextLayoutInformation> layoutInformations) {
		org.eclipse.emf.ecore.EAttribute attribute = booleanTerminal.getAttribute();
		String result;
		Object attributeValue = getValue(eObject, attribute, count);
		art.resource.artext.mopp.ArtextLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, booleanTerminal, attributeValue, eObject);
		String visibleTokenText = getVisibleTokenText(layoutInformation);
		// if there is text for the attribute we use it
		if (visibleTokenText != null) {
			result = visibleTokenText;
		...
		if (result != null && !"".equals(result)) {
			printFormattingElements(foundFormattingElements, layoutInformations, layoutInformation);
			// write result to the output stream
			tokenOutputStream.add(new PrintToken(result, "'" + art.resource.artext.util.ArtextStringUtil.escapeToANTLRKeyword(result) + "'"));
		}
	}
	...
	private art.resource.artext.mopp.ArtextLayoutInformation getLayoutInformation(java.util.List<art.resource.artext.mopp.ArtextLayoutInformation> layoutInformations, art.resource.artext.grammar.ArtextSyntaxElement syntaxElement, Object object, org.eclipse.emf.ecore.EObject container) {
	...
	private String getHiddenTokenText(art.resource.artext.mopp.ArtextLayoutInformation layoutInformation) {
	...
	private String getVisibleTokenText(art.resource.artext.mopp.ArtextLayoutInformation layoutInformation) {
		if (layoutInformation != null) {
