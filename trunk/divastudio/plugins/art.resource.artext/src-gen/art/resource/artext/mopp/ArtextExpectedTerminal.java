...
public class ArtextExpectedTerminal {
	...
	public ArtextExpectedTerminal(art.resource.artext.IArtextExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
