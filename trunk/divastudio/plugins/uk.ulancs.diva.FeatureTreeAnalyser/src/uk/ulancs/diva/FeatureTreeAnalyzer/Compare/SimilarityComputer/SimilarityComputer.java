...
public class SimilarityComputer {
	...
	private String ResultFileHandle;
	...
	public SimilarityComputer(AbstractFeatureModel FirstTree, AbstractFeatureModel SecondTree, SimilarityCriterion Crit, String ResFileHandle) {
		StructureWeight = 1;
		LogicalWeight = 1;
		SiblingWeight = 1;
		SemanticWeight = StructureWeight+LogicalWeight+SiblingWeight+1;
		ResultFileHandle = ResFileHandle;
	...
	public void DetermineSimilarity() {
		SimilarityResult Result = new SimilarityResult(MyMatcher,SemanticWeight,StructureWeight,LogicalWeight,SiblingWeight,ResultFileHandle);
