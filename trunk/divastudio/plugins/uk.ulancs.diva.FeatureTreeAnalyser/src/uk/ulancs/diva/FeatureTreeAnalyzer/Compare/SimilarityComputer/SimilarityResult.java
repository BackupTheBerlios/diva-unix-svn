...
public class SimilarityResult {
	...
	public SimilarityResult(Matcher TheMatcher, Integer SemWeight, Integer StructWeight, Integer LogWeight, Integer SibWeight, String ResFileHandle) {
	...
	public void WriteResult(AbstractFeatureModel Tree1, AbstractFeatureModel Tree2, Long Hours, Long Minutes, Long Seconds) {
		...
		String FileHandle = ResultFileHandle + File.separator + Tree1.GetName() + " - " + Tree2.GetName() + " (" + getDateTime() + ").txt";
