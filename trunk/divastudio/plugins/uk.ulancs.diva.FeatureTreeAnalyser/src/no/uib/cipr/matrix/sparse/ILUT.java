...
public class ILUT implements Preconditioner {
    ...
    private void factor() {
        ...
        L = new UnitLowerFlexCompRowMatrix(LU);
        U = new UpperFlexCompRowMatrix(LU);
    }
     ...
     * value
     */
    private class IntDoubleEntry implements Comparable<IntDoubleEntry> {
     ...
     */
    private class UnitLowerFlexCompRowMatrix extends AbstractMatrix {

        public UnitLowerFlexCompRowMatrix(Matrix LU) {
            super(LU);
        }
     ...
     */
    private class UpperFlexCompRowMatrix extends AbstractMatrix {

        public UpperFlexCompRowMatrix(Matrix LU) {
            super(LU);
        }
