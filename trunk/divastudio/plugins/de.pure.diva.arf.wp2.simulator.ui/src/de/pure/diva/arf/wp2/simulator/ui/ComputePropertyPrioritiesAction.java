...
public class ComputePropertyPrioritiesAction extends DiVAMetaModelAction implements IObjectActionDelegate {
  ...
  protected void run(IProgressMonitor monitor, Resource vmodel) throws Exception {
    ...
    QuestionHandle question = new arf.question.QuestionHandle(WP2SimulatorQuestion.QUESTIONS.COMPUTE_PROPERTY_PRIORITIES);
