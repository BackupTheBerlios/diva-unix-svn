...
public class CompleteSimulationAction extends DiVAMetaModelAction implements IObjectActionDelegate {
  ...
  protected void run(IProgressMonitor monitor, Resource vmodel) throws Exception {
    ...
    monitor.beginTask("Perform complete simulation", IProgressMonitor.UNKNOWN);
    ...
    QuestionHandle question = new arf.question.QuestionHandle(WP2SimulatorQuestion.QUESTIONS.PERFORM_COMPLETE_SIMULATION);
