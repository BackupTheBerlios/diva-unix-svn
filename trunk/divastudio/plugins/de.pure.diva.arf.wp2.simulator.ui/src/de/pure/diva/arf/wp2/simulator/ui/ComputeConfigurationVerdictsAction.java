...
public class ComputeConfigurationVerdictsAction extends DiVAMetaModelAction implements IObjectActionDelegate {
  ...
  protected void run(IProgressMonitor monitor, Resource vmodel) throws Exception {
    ...
    monitor.beginTask("Perform optimising", IProgressMonitor.UNKNOWN);
    ...
    QuestionHandle question = new arf.question.QuestionHandle(WP2SimulatorQuestion.QUESTIONS.COMPUTE_CONFIGURATION_VERDICTS);
