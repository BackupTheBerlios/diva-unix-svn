...
public class KExecMain {
	public static final String DIVA_KERMETA_CODE = "platform:/plugin/diva.model.simulation/kermeta/Main.kmt";
	
	public static void run(String op, String fileURI, IOConsole console) throws NotRegisteredURIException, IOException, URIMalformedException  {

		Interpreter interpreter = new Interpreter(DIVA_KERMETA_CODE, InterpreterMode.RUN, null);
	    interpreter.setStreams(console);		
	    interpreter.setEntryPoint("diva::Main", op);
		...
		Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("diva.model.simulation");
		if(bundle != null){
