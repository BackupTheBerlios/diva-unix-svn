...
public class RunSimulationCoverage implements IObjectActionDelegate, Runnable {

	protected StructuredSelection currentSelection;
    protected IFile file;
	
	public RunSimulationCoverage() {
		super();
	}
	...
	public void run() {
		...
		try {			
			...
			KExecMain.run("printVariantCoverage", file_uri, console);
