...
public class RunSimulationStatsMultiple implements IObjectActionDelegate, Runnable {

	protected StructuredSelection currentSelection;

	
	public RunSimulationStatsMultiple() {
		super();
	}
	...
	public void run() {
		...
		IOConsole console = new EclipseConsole("DiVA Scenario Data");
		console.println(new InfoMessage("Launching..."));
		...
		try {			
			...
			while(it.hasNext()) {
				...
				KExecMain.run("printCSVScenarioSizes", file_uri, console);
			}
