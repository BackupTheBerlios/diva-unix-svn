...
public class RunPopulateCompleteSimulationMultiple implements IObjectActionDelegate, Runnable {

	protected StructuredSelection currentSelection;
	
	public RunPopulateCompleteSimulationMultiple() {
		super();
	}
	...
	public void run() {
		...
		while(it.hasNext()) {
			...
			try {			
				...
				KExecMain.run("populateCompleteSimulation", file_uri, console);
