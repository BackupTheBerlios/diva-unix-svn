...
public class WeaveConfiguration implements IObjectActionDelegate, Runnable {

	protected StructuredSelection currentSelection;
    protected Configuration config;
	
	public WeaveConfiguration() {
		super();
	}
	...
	public void run() {
		...
		WeaveVariants.weaveConfiguration(model, variants, new EclipseConsole("DiVA"), true);
	}
